...
public class MecanumDrive implements DriveMotors {
    ...
    static class Motor {
        ...
        static class Vector2D {
            ...
            static double dotProduct(Vector2D a, Vector2D b) {
                return a.x * b.x + a.y * b.y;
            }

            Vector2D rotatedBy(double angle) {
        ...
        Motor(DcMotor motor, Vector2D vector, Location location) {
            this.motor = motor;
            this.vector = vector;
    ...
    PowerBehavior powerBehavior = PowerBehavior.CLAMP;
    ...
    static MecanumDrive standard(HardwareMap hardwareMap) {
